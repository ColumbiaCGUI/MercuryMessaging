...
1. **Rename to Framework:**
   ```
   RENAME: Assets/MercuryMessaging/ → Assets/Framework/MercuryMessaging/
   ```

2. **Reorganize internal structure:**
   ```
   Assets/Framework/MercuryMessaging/
   ├── Runtime/
...
1. **Create Core folder for hot-path optimized code:**
   ```
   CREATE: Assets/Framework/MercuryMessaging/Runtime/Protocol/Core/
   ```
...
2. **Create StandardLibrary for typed message handlers:**
   ```
   CREATE: Assets/Framework/MercuryMessaging/Runtime/StandardLibrary/
   CREATE: Assets/Framework/MercuryMessaging/Runtime/StandardLibrary/UI/
   CREATE: Assets/Framework/MercuryMessaging/Runtime/StandardLibrary/Input/
   ```
...
3. **Reorganize Tests for performance:**
   ```
   CREATE: Assets/Framework/MercuryMessaging/Tests/Performance/
   CREATE: Assets/Framework/MercuryMessaging/Tests/Integration/
