...
| `Assets/MercuryMessaging/Protocol/Network/Backends/FishNetBackend.cs` | FishNet backend implementation. Primary networking solution. |
| `Assets/MercuryMessaging/Protocol/Network/Backends/Fusion2Backend.cs` | Photon Fusion 2 backend implementation. Alternative networking solution. |
